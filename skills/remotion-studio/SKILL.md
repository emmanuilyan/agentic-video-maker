...
When Studio is used to review a visual composition, attach one PNG still or screenshot of the relevant frame/state with the result. A server URL alone is not a visual handoff; skip the PNG for Studio setup questions.
