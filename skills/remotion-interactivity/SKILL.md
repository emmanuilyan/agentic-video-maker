...
When a task changes a visible composition or interaction state, include a PNG screenshot or still of the relevant state with the code or app result. For API-only or nonvisual changes, skip it.
