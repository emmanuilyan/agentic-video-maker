...
When the task produces or changes a visible Player, editor, or application screen, include one PNG screenshot at a useful viewport. For backend, deployment, or architecture-only work, skip it unless a diagram materially helps.
