...
When the selected workflow changes or creates a visible composition, include one useful PNG still, screenshot, or contact sheet with the main deliverable; omit images for text-only or API-only answers.
