...
Attach before/after PNG frames only when an upgrade changes a rendered composition or the user asks for visual regression evidence. For dependency-only upgrades, do not create an unrelated image.
