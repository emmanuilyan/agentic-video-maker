...
This skill usually returns an explanation or code reference, so do not force a PNG into documentation-only answers. If the answer itself describes a visual composition and a diagram materially clarifies it, provide that diagram as PNG.
