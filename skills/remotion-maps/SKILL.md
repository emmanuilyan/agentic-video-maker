...
When creating a map composition, include a PNG of the final static map or one representative frame from the animation. For technique lookup without a visual result, skip it.
