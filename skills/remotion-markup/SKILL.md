...
When markup changes a visual composition, attach one PNG still of the changed area or key state. Reuse Studio or QA evidence, and skip new renders for trivial or nonvisual edits.
